package com.superv.alarm.recorder;
...
//        builder.setContentIntent(pIntent);// 将意图设置到通知上
        // 简洁写法
        builder.setContentIntent(PlayAlarmActivity.startPendingIntent(this, ""));// 将意图设置到通知上
        ...
        PendingIntent completePIntent = PlayAlarmActivity.startPendingIntent(this, Constant.NOTIFI_FINISH_MSG);//设置完成录音 PendingIntent
