package com.superv.alarm.Utils.file;
...
public class FileManager {
    ...
    private static String mAudioFolderPaths = null;
    ...
    private static void initPath() {
        ...
        mAudioFolderPaths = mAppFolderPath + "Audio";// 音频文件路径
    ...
    public static String getAudioFoldersPath() {
        return fixPath(mAudioFolderPaths);
    }
    /**
     * 修复文件夹路径
     * @param path 文件夹路径
