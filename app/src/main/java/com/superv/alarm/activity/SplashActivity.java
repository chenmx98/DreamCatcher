...
import com.superv.alarm.NotificationPermissionUtil;
import com.superv.alarm.R;
import com.superv.alarm.Utils.crash.CrashHandler;
import com.superv.alarm.Utils.file.FileManager;
import com.superv.alarm.dialog.CheckDialog;
...
//        DownloadConfig.INSTANCE.init(builder);
    ...
    private void initCrashHandler() {
        CrashHandler.get()
                .setLauncherClass(PlayAlarmActivity.class)// 如果不设置重启的Activity，闪退后就直接退出应用
                .setInterceptor(true)
//                .setToastTips("嗝屁啦")
